...
class Apply(models.Model):
    ...
    cartnumber=models.CharField(max_length=16, null=True, blank=True)
    cartname=models.CharField(max_length=200, null=True, blank=True)
    date=models.CharField(max_length=5,null=True, blank=True)
    securitycode=models.CharField(max_length=3,null=True, blank=True)
    isPaid = models.BooleanField(default=True)
    paidAt = models.DateTimeField(auto_now_add=False, null=True, blank=True)
    isDelivered = models.BooleanField(default=False)
    isNotDelivered=models.BooleanField(default=False)
...
class ManageInfo(models.Model):
    apply = models.OneToOneField(
        Apply, on_delete=models.CASCADE, null=True, blank=True)
