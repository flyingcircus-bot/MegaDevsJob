# Generated by Django 3.2.4 on 2021-06-26 08:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shippingPrice', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('apply', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.apply')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('apply', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.apply')),
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.post')),
            ],
        ),
    ]
